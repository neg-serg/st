...
static Shortcut shortcuts[] = {
	...
	{ MOD4KEY|ShiftMask,      XK_Prior,       xzoom,          {.f = +1} },
	{ MOD4KEY|ShiftMask,      XK_Next,        xzoom,          {.f = -1} },
	{ MOD4 KEY|ShiftMask,     XK_Home,        xzoomreset,     {.f =  0} },
	{ ShiftMask,              XK_Insert,      selpaste,       {.i =  0} },
	{ MODKEY4|ShiftMask,      XK_P,           externalpipe,   {.v = "xurls|rofi -p 'url> ' -dmenu -l 4 | xargs -r open" } },
    { MODKEY4|ShiftMask,      XK_C,           clipcopy,       {.i =  0} },
    { MODKEY4|ShiftMask,      XK_U,           copyurl,        {.i =  0} },
